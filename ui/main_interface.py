...
# --- Import depuis les modules core et utils ---
from core.data_ademe import fetch_ademe_all
from core.data_dvf import get_dvf_data
from core.geodata import compute_barycenter, filter_ademe_data_by_radius, get_postal_codes_in_radius
...
def render_main_interface():
    ...
    # TITRE + DESCRIPTION
    # -------------------------------------------------------
    st.title("🏠 Carte interactive DPE / GES + DVF + Calques postaux & cadastraux")
    st.markdown(
        "Visualisez les logements, leurs DPE, les ventes DVF, "
        "et superposez les zones postales et cadastrales. "
        "Utilisez le repère manuel pour centrer votre recherche."
    )
    ...
    # -------------------------------------------------------
    # INTERACTION CARTE - CLIC POUR REPÈRE
    # -------------------------------------------------------
